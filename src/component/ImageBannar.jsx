...
const ImageBannar=()=>{
    return(
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center bg-black/20 px-4 space-y-4 ">
              <img src='https://res.cloudinary.com/dg1okcxsx/image/upload/v1750519325/betquix_white_logo_1-removebg-preview_ce4ouc.png' className="w-[220px] h-auto mx-auto"  alt=''></img>
              <p className="text-xl">Enjoy your game and do not forget to share them with your friends.</p>
